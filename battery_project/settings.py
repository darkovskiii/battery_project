"""
Django settings for battery_project project.
...
ROOT_URLCONF = 'battery_project.urls'
...
WSGI_APPLICATION = 'battery_project.wsgi.application'
...
PAYPAL_RECEIVER_EMAIL = 'receive@battery.com'